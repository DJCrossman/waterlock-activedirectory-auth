...
exports.authType = 'activedirectory';
...
var localPath = path.normalize(__dirname+'/../../../config/local.js');
var localconfig = module_exists(localPath) ? require(localPath) : {};
wlconfig = Object.assign(wlconfig, localconfig.waterlock);

var method = {};
if(_.isArray(wlconfig.authMethod)){
  method = _.findWhere(wlconfig.authMethod, {name: 'waterlock-activedirectory-auth'});
}else{
